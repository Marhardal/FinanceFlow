        ...
        <div class="grid grid-cols-4 gap-4">
          ...
          <div class="col-span-3" v-if="Budget.income">
            <p class="text-md">{{ Budget.income.name + "->" + Budget.income.amount.toLocaleString('en-mw', {
              minimumFractionDigits: 2, style: 'currency', currency: 'MWK' }) }}</p>
          </div>
          <div class="col-span-1">
          ...
          <div class="col-span-3" v-if="Budget.spentAmount != null">
            <p class="text-md">{{ Budget.spentAmount.toLocaleString('en-mw', {
              minimumFractionDigits: 2, style:
                'currency', currency: 'MWK' }) }}</p>
          </div>
          <div class="col-span-1">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                      ...
                      <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                        <tr class="hover:bg-gray-100 dark:hover:bg-neutral-500 hover:rounded"
                          ...
                          <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800" v-if="expense.item">
                            {{ expense.item.name }}</td>
                          <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 ">{{ expense.quantity }}</td>
                          <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800" v-if="expense.item">{{
